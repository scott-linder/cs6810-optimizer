...
/**
 * <p>
 * Title: IcallInstruction.java
 * </p>
 *
 * <p>
 * Description: An function call with an integer return value.
 * </p>
 *
 * <p>
...
public class IcallInstruction extends InvocationInstruction {
	 ...
	 * @param returnReg
	 *            the return register id
	 */
	public IcallInstruction(LabelOperand name, Vector parameters, VirtualRegisterOperand returnReg) {
		operands = new Vector();
		operands.add(name);
