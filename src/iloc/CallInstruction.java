...
/**
 * <p>Title: CallInstruction.java</p>
 *
 * <p>Description: An iloc call instruction.</p>
 *
...
public class CallInstruction extends InvocationInstruction {
	 ...
	 * @param parameters a Vector of operands to the call instruction.
	 */
  public CallInstruction(LabelOperand name,
                         Vector parameters) {
    operands = new Vector();
    operands.add(name);
