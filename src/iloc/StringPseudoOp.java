...
/**
 * <p>Title: StringPseudoOpInstruction.java</p>
 *
 * <p>Description: A string pseudo op to declare a character string value</p>
 *
...
public class StringPseudoOp extends PseudoOpInstruction {
   ...
   * @param val the string itslef
   */
  public StringPseudoOp(String name,
                        String val) {
    this.name = name;
    this.val = val;
  }
