...
/**
 * <p>Title: MultIInstruction.java</p>
 *
 * <p>Description: An integer multiply immediate instruction</p>
 *
...
public class MultIInstruction extends ThreeAddressIlocInstruction {
   ...
   * @param source2 the immediate operand
   * @param dest the destination register
   */
  public MultIInstruction(VirtualRegisterOperand source1,
