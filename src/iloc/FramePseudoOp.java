...
/**
 * <p>
 * Title: FramePseudoOp.java
 * </p>
 *
 * <p>
 * Description: An iloc declaration of a procedure stack frame.
 * </p>
 *
 * <p>
...
public class FramePseudoOp extends PseudoOpInstruction {
	 ...
	 * @param parameters
	 *            the formal register parameters to the function
	 */
	public FramePseudoOp(String name, int localSize, Vector parameters) {
		this.name = name;
