...
/**
 * <p>Title: LshiftIInstruction.java</p>
 *
 * <p>Description: A left shift immediate instruction</p>
 *
...
public class LshiftIInstruction extends ThreeAddressIlocInstruction {
   ...
   * @param source2 the immediate value to shift by
   * @param dest the destination register.
   */
  public LshiftIInstruction(VirtualRegisterOperand source1,
