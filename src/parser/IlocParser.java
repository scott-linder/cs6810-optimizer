...
public class IlocParser implements IlocParserConstants {
	...
	static final public IlocProgram program() throws ParseException {
		...
		case LABEL:
			...
			FramePseudoOp frameOp = new FramePseudoOp("main", 0, new Vector<VirtualRegisterOperand>());
	...
	static final public DataSection data() throws ParseException {
	...
	static final public Vector<IlocInstruction> procedures() throws ParseException {
	...
	static final public Vector<IlocInstruction> procedure() throws ParseException {
	...
	static final public Vector<IlocInstruction> listOfIlocInstructions() throws ParseException {
		IlocInstruction inst;
	...
	static final public FramePseudoOp frameInstruction() throws ParseException {
		...
		frameOp = new FramePseudoOp(routineName.image, Integer.parseInt(stackSize.image), vRegs);
	...
	static final public Vector<IlocInstruction> operationList() throws ParseException {
		Token name;
		IlocInstruction inst;
	...
	static final public IlocInstruction operation() throws ParseException {
		...
		case ADDI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new AddIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case AND:
		...
		case CBR_LT:
			...
			inst = new Cbr_ltInstruction(vr1, new LabelOperand(label.image), new LabelOperand(label1.image));
			break;
		case CBR_LE:
			...
			jj_consume_token(COMMA);
			label1 = jj_consume_token(LABEL);
			inst = new Cbr_leInstruction(vr1, new LabelOperand(label.image), new LabelOperand(label1.image));
			break;
		case CBR_EQ:
			...
			jj_consume_token(COMMA);
			label1 = jj_consume_token(LABEL);
			inst = new Cbr_eqInstruction(vr1, new LabelOperand(label.image), new LabelOperand(label1.image));
			break;
		case CBR_NE:
			...
			jj_consume_token(COMMA);
			label1 = jj_consume_token(LABEL);
			inst = new Cbr_neInstruction(vr1, new LabelOperand(label.image), new LabelOperand(label1.image));
			break;
		case CBR_GT:
			...
			jj_consume_token(COMMA);
			label1 = jj_consume_token(LABEL);
			inst = new Cbr_gtInstruction(vr1, new LabelOperand(label.image), new LabelOperand(label1.image));
			break;
		case CBR_GE:
			...
			jj_consume_token(COMMA);
			label1 = jj_consume_token(LABEL);
			inst = new Cbr_geInstruction(vr1, new LabelOperand(label.image), new LabelOperand(label1.image));
			break;
		case CLOADAI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new CloadAIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case CLOADAO:
		...
		case CSTOREAI:
			...
			jj_consume_token(COMMA);
			num = jj_consume_token(NUMBER);
			inst = new CstoreAIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case CSTOREAO:
		...
		case DIVI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new DivIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case DIV:
		...
		case FLOADAI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new FloadAIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case FLOADAO:
		...
		case FSTOREAI:
			...
			jj_consume_token(COMMA);
			num = jj_consume_token(NUMBER);
			inst = new FstoreAIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case FSTOREAO:
		...
		case LOADAI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new LoadAIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case LOADAO:
		...
		case LSHIFTI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new LshiftIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case LSHIFT:
		...
		case MULTI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new MultIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case MULT:
		...
		case RSHIFTI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new RshiftIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case RSHIFT:
		...
		case STOREAI:
			...
			jj_consume_token(COMMA);
			num = jj_consume_token(NUMBER);
			inst = new StoreAIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case STOREAO:
		...
		case SUBI:
			...
			jj_consume_token(ASSIGN);
			vr3 = virtualReg();
			inst = new SubIInstruction(vr1, new ConstantOperand(Integer.parseInt(num.image)), vr3);
			break;
		case SUB:
	...
	static final public IlocInstruction pseudoOp() throws ParseException {
		...
		case STRING:
			...
			if (true)
				return new StringPseudoOp(label.image, str.image.substring(1, str.image.length() - 1));
		}
			break;
		case FLOAT:
		...
		case GLOBAL:
			...
			if (true)
				return new GlobalPseudoOp(label.image, Integer.parseInt(num.image), Integer.parseInt(num1.image));
		}
			break;
		default:
			jj_la1[13] = jj_gen;
	...
	static final public VirtualRegisterOperand virtualReg() throws ParseException {
		Token vr;
	...
	static final public ImmediateOperand immediateVal() throws ParseException {
		Token label, num;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case LABEL:
			label = jj_consume_token(LABEL); {
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x0, 0xffffffe0, 0x0, 0x0, 0x0, 0xffffffe0, 0xffffffe0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xffffffe0, 0x0, 0x0, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x4, 0xfeffbfff, 0x1004000, 0x10000, 0x0, 0xfefebffb, 0xfefebffb, 0x0, 0x0, 0x0, 0x0,
				0x0, 0xfefebffb, 0x1004000, 0x0, };
	}

	private static void jj_la1_init_2() {
		jj_la1_2 = new int[] { 0x0, 0x3ff7ffff, 0x80000, 0x0, 0x0, 0x3ff7ffff, 0x3ff7ffff, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x3ff7ffff, 0x80000, 0x0, };
	}

	private static void jj_la1_init_3() {
		jj_la1_3 = new int[] { 0x0, 0x108, 0x0, 0x0, 0x100, 0x8, 0x108, 0x20, 0x4, 0x20, 0x20, 0x20, 0x0, 0x0,
				0x8100, };
	}
